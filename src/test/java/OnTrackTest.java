...
public class OnTrackTest {
	...
	public void testSubmitaTask() {
		...
		assertNotNull(task);
		assertEquals("s222121587", task.getStudentId());
	}

	@Test
	public void testStatuslessthanday() {
		result.taskSubmit("SIT333P2", "s222121587", now.plusHours(23));
	...
	public void testStatuslessanHour() {
		result.taskSubmit("SIT333P3", "s222121587", now.plusMinutes(55));
	...
	public void testStatusDeadlinepass() {
		result.taskSubmit("SIT333P4", "s222121587", now.minusMinutes(10));
	...
	public void testSubmittedTest() {
		result.taskSubmit("SIT333P5", "s222121587", now.plusHours(30));
	...
	@Test
	public void testStatusMoreThanADay() {
		result.taskSubmit("SIT333P6", "s222121587", now.plusDays(2));
